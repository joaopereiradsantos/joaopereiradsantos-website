...
- company: Amazon
  ...
  description: |-
   <font size="2.5"><span style="color:grey">**Transportation & Supply Chain (EU IXD)**</span></font>\
   - **Placement Impact Calculator & Algorithm:**
      ...
      - End to end algorithm and automation with AWS: EC2, SageMaker and Web Application Deployment with Elastic Beanstalk).
